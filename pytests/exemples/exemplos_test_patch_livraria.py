exemples_patch_livraria_invalid_payload = [
    ("payload_vazio", 400),
    ("None", 400),
    ("null", 400),
    ("hash_vazio", 400),
...
exemples_patch_livraria_invalid_values = [
    ("nome", "123", 400),
...
exemples_patch_livraria_no_fields = [
    ("nome", 200),
    ("autor", 200),
    ("dataPublicacao", 200),
    ("qtdePaginas", 200)
...
exemples_patch_id_livraria_invalid_values = [
    ("123", 400),
    ("123_to_i", 400),
    ("123_to_f", 400),
    ("None", 400),
